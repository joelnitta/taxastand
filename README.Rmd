...
**NOTE:** This package is under **active development**. Functions may change drastically, and the user should not expect the interface to stay consistent.
...
[taxize](https://github.com/ropensci/taxize) is the "granddaddy" of taxonomy packages in R. It can search around 20 different taxonomic databases for names and retrieve taxonomic information. It does not store any databases locally.
